...
| ------------ | ------------------------------------------------------- | ------------ | ----------------------------------------------------------------------------- |
| `bytecode`   | Functions and constants for working with Luau bytecode. | None         | [`[ docs ]`](./docs/modules/bytecode.md)<br/>[`[ src ]`](./src/bytecode/)     |
| `loadstring` | Loadstring implementation. Note: Only accepts bytecode. | None         | [`[ docs ]`](./docs/modules/loadstring.md)<br/>[`[ src ]`](./src/loadstring/) |
